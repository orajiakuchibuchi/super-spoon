...
export class HeaderComponent implements OnInit {
  ...
  nav(page:any) {
    if(page){
      this.scriptSevice.changePage(page);
    }
  }
  jsinit() {
    "use strict";
    ...
    const select = (el: any, all = false) => {
      el = el.trim()
      if (all) {
        const c: any = document.querySelectorAll(el);
        return [...c]
      } else {
